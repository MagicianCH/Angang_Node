...
{
	u16 SAMPLING_LENGTH1_PRE = 1000;  //第一通道采样长度，轴向
	u16 SAMPLING_LENGTH2_PRE = 1000;  //第二三通道采样长度
	u16 SAMPLING_RATE1_PRE = 10000; //第一通道采样率
	u16 SAMPLING_RATE2_PRE = 10000;  //第二三通道
